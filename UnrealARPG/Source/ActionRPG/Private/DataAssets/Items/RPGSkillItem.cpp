...
#include "RPGSkillItem.h"

URPGSkillItem::URPGSkillItem(const FObjectInitializer& objectInitializer) :Super(objectInitializer)
{
	ItemType = ERPGItemType::Skill;
}

TSharedPtr<FJsonObject> URPGSkillItem::ToJson()
{
...
bool URPGSkillItem::FromJson(FJsonObject& jsonObject)
{
